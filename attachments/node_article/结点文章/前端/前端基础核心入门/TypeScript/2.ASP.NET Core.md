...
首先，若有必要请[安装 ASP.NET Core](https://get.asp.net/)。 这个快速上手指南使用的是 Visual Studio ，若要使用 ASP.NET Core 你需要有 Visual Studio 2015。
...
4.  选择 **ASP.NET Web Application**
    ...
    ![Create new ASP.NET project](https://www.tslang.cn/assets/images/tutorials/aspnet/new-asp-project.png)
    
5.  选择 **ASP.NET 5 Empty** 工程模板
    
    取消复选 "Host in the cloud" 本指南将使用一个本地示例。 ![Use empty template](https://www.tslang.cn/assets/images/tutorials/aspnet/new-asp-project-empty.png)
...
![Create new folder](https://www.tslang.cn/assets/images/tutorials/aspnet/new-folder.png)

将文件夹命名为 `scripts`。

![scripts folder](https://www.tslang.cn/assets/images/tutorials/aspnet/scripts-folder.png)

## 添加 TypeScript 代码

在`scripts`上右击并选择**New Item**。 接着选择 **TypeScript File**（也可能 .NET Core 部分），并将此文件命名为`app.ts`。

![New item](https://www.tslang.cn/assets/images/tutorials/aspnet/new-item.png)
...
![Create tsconfig.json](https://www.tslang.cn/assets/images/tutorials/aspnet/new-tsconfig.png)
...
![Refresh Task Runner Explorer](https://www.tslang.cn/assets/images/tutorials/aspnet/task-runner-explorer.png)
...
![Picture of running demo](https://www.tslang.cn/assets/images/tutorials/aspnet/running-demo.png)
...
![Demo paused on breakpoint](https://www.tslang.cn/assets/images/tutorials/aspnet/paused-demo.png)
