+   [**1\.** Go语言的主要特征](#go语言的主要特征)

+   [**1.1.** golang 简介](#golang-简介)

+   [**1.1.1.** 来历](#来历)
+   [**1.1.2.** 思想](#思想)
+   [**1.1.3.** 优点](#优点)
+   [**1.1.4.** Go语言的主要特征：](#go语言的主要特征：)
+   [**1.1.5.** Golang文件名：](#golang文件名：)
+   [**1.1.6.** Go语言命名：](#go语言命名：)
+   [**1.1.7.** Go语言声明：](#go语言声明：)
+   [**1.1.8.** Go项目构建及编译](#go项目构建及编译)
+   [**1.1.9.** go 编译问题](#go-编译问题)

[](#go语言的主要特征)

## [](#go语言的主要特征)1\. Go语言的主要特征

## [](#golang-简介)1.1. golang 简介
