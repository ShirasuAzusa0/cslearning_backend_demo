...
### [编写和运行 Rust 程序](#编写和运行-rust-程序)

接下来，创建一个源文件并命名为 *main.rs*。Rust 文件通常以 *.rs* 扩展名结尾。如果文件名中使用了多个单词，请使用下划线将它们隔开。例如，命名为 *hello\_world.rs*，而不是 *helloworld.rs*。
...
[](https://rustwiki.org/zh-CN/book/ch01-01-installation.html "Previous chapter")[](https://rustwiki.org/zh-CN/book/ch01-03-hello-cargo.html "Next chapter")
